...
int catLandmarks[NUM_LANDMARKS] =
{
    4263,
    4671,
    3853,
...
int lionLandmarks[NUM_LANDMARKS] =
{
    2613,
    2376,
    3602,
...
MatrixXd Lc(
    source.eigenvectors.cols(),
    NUM_LANDMARKS);

MatrixXd Ll(
    target.eigenvectors.cols(),
    NUM_LANDMARKS);
...
// Concatenate descriptors + landmarks

MatrixXd Aall(
    A.rows(),
    A.cols()+NUM_LANDMARKS);

MatrixXd Ball(
    B.rows(),
    B.cols()+NUM_LANDMARKS);
